...
public class JDBCUtils {
    ...
    public static int updateQuery(Connection connection,String sql,Object ... args){
        PreparedStatement ps = null;
        try {
            ps = connection.prepareStatement(sql);
    ...
    public static <T> T queryForOne(Class<T> clazz,Connection connection, String sql, Object ... args){
